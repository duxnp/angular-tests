...
import { EntityPageState } from '@ng-tests/shared/domain';
import { RootSelectors } from '@ng-tests/shared/root/data-access';
import { ToastsActions } from '@ng-tests/shared/toasts/data-access';
