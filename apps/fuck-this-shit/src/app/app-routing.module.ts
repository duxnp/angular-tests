...
const routes: Routes = [
  ...
  {
    path: 'concept-tests',
    loadChildren: () => import('./modules/concept-tests/concept-tests.module').then(m => m.ConceptTestsModule),
  },
  {
    path: 'lazy',
    loadChildren: () => import('./modules/lazy-hmr/lazy-hmr.module').then(m => m.LazyHmrModule),
  },
  {
    path: 'articles',
